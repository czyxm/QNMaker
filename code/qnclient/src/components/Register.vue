<template>
    <div class="register">
      <el-card class="main-register">
        <div slot="header" class="clearfix">
          <div class="link">
            <el-link type="danger" :underline="false" href="/login">登录已有账号<i class="el-icon-user-solid"></i></el-link>
          </div><br/>
          <div class="title">注 册 QNMaker</div>
        </div>
        <!-- 注册表单 -->
        <el-row>
          <el-form  :model="registerForm" status-icon :rules="rules" size="medium" ref="registerForm" label-width="100px" class="demo-registeForm">
            ...
            <el-form-item prop="email" label="邮箱">
              <el-input @keyup.enter.native="Register('registerForm')" v-model="registerForm.email" placeholder="请输入邮箱地址"></el-input>
            </el-form-item>
            ...
            <el-form-item style="margin-left: -25%">
              <el-button type="danger" @click="Register('registerForm')" plain round>注册</el-button>
              <el-button type="danger" @click="resetForm('registerForm')" style="margin-right: -5%" plain round>重置</el-button>
            </el-form-item>
          </el-form>
        </el-row>
      </el-card>
...
<script>
    ...
    data() {
      ...
      var validateEmail = (rule, value, callback) => {
        ...
        } else if (/^([a-zA-Z]|[0-9])(\w|-)+@([a-zA-Z0-9]+\.([a-zA-Z]{2,4})){1,2}$/.test(value)) {
          callback();
        } else {
      ...
      return {
        ...
        rules: {
          ...
          email: [
            ...
            {max: 320, message: '邮箱长度最长320位', trigger: 'blur' }
          ],
        // 密码验证规则
        pass: [
